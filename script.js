...
function showFoodList() {
    ...
    if (!isAlertActive) {
        document.getElementById("alert-icon").setAttribute("class", "navbar-icon");
    }
    updateItems();
}
...
function showAlerts() {
    ...
    document.getElementById("alert").innerHTML = '<img class="navbar-current" id="alert-icon" src="https://cdn-icons-png.flaticon.com/512/550/550096.png">';
